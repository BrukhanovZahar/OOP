...
int main() {
    try {
        ...
        Five five6 = five2;
        std::cout << "five6: " << five6 <<
                  std::endl;

        Five five7 = std::move(five3);
        std::cout << "five7: " << five7 <<
                  std::endl;

        Five five8 = five7 + five2;
        std::cout << "Five8 (Five7 + Five2): " << five8 <<
                  std::endl;

        Five five9 = five2 + five7;
        std::cout << "Five9 (Five2 + Five7): " << five9 <<
                  std::endl;

        Five five10 = five7 + five7;
        std::cout << "Five10 (Five7 + Five7): " << five10 <<
                  std::endl;

        Five five11 = five2 - five7;
        std::cout << "Five11 (Five2 - Five7): " << five11 <<
                  std::endl;

        Five five12 = five2 - five5;
        std::cout << "Five12 (Five2 - Five5): " << five12 <<
                  std::endl;

        std::cout << (five5 > five6) <<
                  std::endl;
        std::cout << (five5 < five6) <<
                  std::endl;
        std::cout << (five5 == five6) <<
